...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler,
    ...
    private static final int SUNSHINE_WEATHER_LOADER_ID = 20;
    private static final String WEATHER_LOCATION_EXTRA = "LOCATION_EXTRA";
    ...
    private void loadWeatherData() {
        ...
        if (getSupportLoaderManager().getLoader(SUNSHINE_WEATHER_LOADER_ID) == null) {
            getSupportLoaderManager().initLoader(SUNSHINE_WEATHER_LOADER_ID, null, this);
        } else {
            getSupportLoaderManager().restartLoader(SUNSHINE_WEATHER_LOADER_ID, null, this);
        }
    }
